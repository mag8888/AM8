...
// Конфигурация фишек (10 фишек)
const TOKENS_CONFIG = [
    {
        id: 'entrepreneur',
        name: 'Предприниматель',
        icon: '💼',
        description: 'Амбициозный бизнесмен, стремящийся к финансовой независимости'
    },
    {
        id: 'investor',
        name: 'Инвестор',
        icon: '📈',
        description: 'Опытный инвестор, знающий толк в прибыльных вложениях'
    },
    {
        id: 'real_estate',
        name: 'Риелтор',
        icon: '🏠',
        description: 'Специалист по недвижимости с острым чутьем на выгодные сделки'
    },
    {
        id: 'developer',
        name: 'Разработчик',
        icon: '💻',
        description: 'IT-специалист, создающий цифровые продукты и решения'
    },
    {
        id: 'consultant',
        name: 'Консультант',
        icon: '🎯',
        description: 'Эксперт по финансам, помогающий другим достичь успеха'
    },
    {
        id: 'artist',
        name: 'Художник',
        icon: '🎨',
        description: 'Творческая личность, монетизирующая свои таланты'
    },
    {
        id: 'teacher',
        name: 'Учитель',
        icon: '👨‍🏫',
        description: 'Педагог, обучающий финансовой грамотности'
    },
    {
        id: 'doctor',
        name: 'Врач',
        icon: '👩‍⚕️',
        description: 'Медицинский работник с высоким доходом'
    },
    {
        id: 'lawyer',
        name: 'Юрист',
        icon: '⚖️',
        description: 'Правовой эксперт, защищающий интересы клиентов'
    },
    {
        id: 'freelancer',
        name: 'Фрилансер',
        icon: '🚀',
        description: 'Свободный специалист, работающий на себя'
    }
];
