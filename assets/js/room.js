...
// Конфигурация мечт (реальные финансовые цели из игры)
const DREAMS_CONFIG = [
    {
        id: 'real_estate_portfolio',
        name: 'Портфель недвижимости',
        description: 'Собрать портфель из 10 доходных объектов недвижимости',
        cost: 2000000,
        icon: '🏠'
    },
    {
        ...
        description: 'Создать диверсифицированный портфель акций на $1M',
        cost: 1000000,
        icon: '📈'
    },
    {
        id: 'business_empire',
        name: 'Бизнес-империя',
        description: 'Построить сеть из 5 успешных бизнесов',
        cost: 5000000,
        icon: '🏢'
    },
    {
        id: 'crypto_fortune',
        name: 'Крипто-состояние',
        description: 'Накопить криптовалютное состояние на $2M',
        cost: 2000000,
        icon: '₿'
    },
    {
        id: 'education_mastery',
        name: 'Мастерство в финансах',
        description: 'Получить все возможные финансовые знания и сертификаты',
        cost: 100000,
        icon: '🎓'
    },
    {
        ...
        name: 'Полная защита',
        description: 'Обеспечить полное страхование всех активов',
        cost: 500000,
        icon: '🛡️'
    },
    {
        id: 'charity_legacy',
        name: 'Благотворительное наследие',
        description: 'Создать фонд для помощи людям на $10M',
        cost: 10000000,
        icon: '❤️'
    },
    {
        ...
        description: 'Настроить идеальную налоговую стратегию',
        cost: 50000,
        icon: '🏛️'
    },
    {
        ...
        description: 'Полностью избавиться от всех долгов',
        cost: 0,
        icon: '💳'
    },
    {
        ...
        description: 'Достичь пассивного дохода $50,000/месяц',
        cost: 6000000,
        icon: '💰'
    }
];
