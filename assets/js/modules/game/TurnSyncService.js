...
class TurnSyncService {
     ...
     */
    startSync() {
        // Увеличиваем интервал до 10 секунд для снижения нагрузки на сервер
        this.syncInterval = setInterval(() => {
            this.syncGameState();
        }, 15000); // Увеличили до 15000мс для предотвращения 429 ошибок
        
        console.log('🔄 TurnSyncService: Периодическая синхронизация запущена');
    }
