...
class PlayersPanel {
    ...
    updateControlButtons(state) {
        ...
        // Логика для кнопки "Бросить" - активна если это мой ход
        if (rollBtn) {
            // ИСПРАВЛЕНО: Если это мой ход, кнопка активна независимо от state.canRoll
            // state.canRoll может быть false после броска, но кнопка должна быть активна для следующего хода
